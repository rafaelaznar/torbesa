            ...
            <%@ page import="java.util.List" %>
                <%@ page import="java.time.format.DateTimeFormatter" %>
                    <% UserBean sessionUser=(UserBean) session.getAttribute("sessionUser"); if (sessionUser==null) {
                        response.sendRedirect("../shared/login.jsp"); return; } ScoreDto userScore=(ScoreDto)
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-3">
                                                                    <div class="stats-number">
                                                                        <%= userScore !=null ? userScore.getScore() : 0
                                                                            %>
                                                                    </div>
                                                                ...
                                                                <div class="col-md-3">
                                                                    <div class="stats-number">
                                                                        <%= userScore !=null ? userScore.getTries() : 0
                                                                            %>
                                                                    </div>
                                                                ...
                                                                <div class="col-md-3">
                                                                    <div class="stats-number">
                                                                        <%= userScore !=null && userScore.getTries()> 0
                                                                            ? String.format("%.1f",
                                                                            (userScore.getScore() * 100.0 /
                                                                            userScore.getTries())) : "0" %>%
                                                                    </div>
                                                                    <p class="mb-0">Precisión</p>
                                                                </div>
                                                                <div class="col-md-3">
                                                                    <div class="stats-number">
                                                                        <% int userRank=0; if (allScores !=null &&
                                                                            userScore !=null) { for (int i=0; i <
                                                                            allScores.size(); i++) { if
                                                                            (allScores.get(i).getUsername().equals(sessionUser.getUsername()))
                                                                            { userRank=i + 1; break; } } } %>
                                                            ...
                                                            <% if (userScore !=null && userScore.getTries()> 0) { %>
                                                                <div class="accuracy-bar mt-3">
                                                                    <div class="accuracy-fill"
                                                                        style="width: <%= (userScore.getScore() * 100 / userScore.getTries()) %>%">
                                                                    </div>
                                                                </div>
                                                                <% } %>
                                                        </div>
                                                    ...
                                                    <div class="ranking-card">
                                                        ...
                                                        <div class="podium">
                                                            ...
                                                            <div class="podium-place podium-2">
                                                                ...
                                                                <h5 class="fw-bold">
                                                                    <%= highScores.get(1).getUsername() %>
                                                                </h5>
                                                                <div class="fs-3 fw-bold">
                                                                    <%= highScores.get(1).getScore() %>
                                                                </div>
                                                                <small>puntos</small>
                                                                <div class="mt-2">
                                                                    <small>
                                                                        <%= highScores.get(1).getTries() %> intentos
                                                                    </small>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="podium-place podium-1">
                                                                <div class="podium-crown">👑</div>
                                                                <h4 class="fw-bold">
                                                                    <%= highScores.get(0).getUsername() %>
                                                                </h4>
                                                                <div class="fs-1 fw-bold">
                                                                    <%= highScores.get(0).getScore() %>
                                                                </div>
                                                                <small>puntos</small>
                                                                <div class="mt-2">
                                                                    <small>
                                                                        <%= highScores.get(0).getTries() %> intentos
                                                                    </small>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="podium-place podium-3">
                                                                <div class="podium-crown">🥉</div>
                                                                <h5 class="fw-bold">
                                                                    <%= highScores.get(2).getUsername() %>
                                                                </h5>
                                                                <div class="fs-3 fw-bold">
                                                                    <%= highScores.get(2).getScore() %>
                                                                </div>
                                                                <small>puntos</small>
                                                                <div class="mt-2">
                                                                    <small>
                                                                        <%= highScores.get(2).getTries() %> intentos
                                                                    </small>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="ranking-card">
                                                            <ul class="nav nav-tabs" id="rankingTabs" role="tablist">
                                                                <li class="nav-item" role="presentation">
                                                                    <button class="nav-link active" id="top10-tab"
                                                                        data-bs-toggle="tab" data-bs-target="#top10"
                                                                ...
                                                                <div class="tab-pane fade show active" id="top10"
                                                                    ...
                                                                    <div class="table-responsive">
                                                                        <table class="table table-hover">
                                                                            ...
                                                                            <tbody>
                                                                                <% if (highScores !=null) { for (int
                                                                                    i=0; i < highScores.size(); i++) {
                                                                                    ScoreDto score=highScores.get(i);
                                                                                    String rankClass=i==0 ? "rank-1" :
                                                                                    i==1 ? "rank-2" : i==2 ? "rank-3"
                                                                                    : "rank-other" ; boolean
                                                                                        ...
                                                                                        <td>
                                                                                            <div
                                                                                                ...
                                                                                                <div class="accuracy-bar flex-grow-1"
                                                                                                    ...
                                                                                                    <div class="accuracy-fill"
                                                                                                        style="width: <%= score.getTries() > 0 ? (score.getScore() * 100 / score.getTries()) : 0 %>%; background: #28a745;">
                                                                                                    </div>
                                                                                                </div>
                                                                                            </div>
                                                                                        </td>
