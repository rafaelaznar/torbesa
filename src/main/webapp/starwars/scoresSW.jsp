...
<head>
    ...
    <title>High Scores - Star Wars's Game</title>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-10">
                ...
                <div class="text-center mb-4">
                    <h1 class="display-4 text-primary"><i class="bi bi-trophy-fill"></i>Game Results</h1>
                </div>
                    ...
                    <div class="col-md-6">
                        <div class="card shadow-sm border-0 h-100">
                            <div class="card-header bg-info text-white">
                                <h5 class="card-title mb-0"><i class="bi bi-question-circle-fill"></i>Your Answer</h5>
                            </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    <h5>
                                        ...
                                        <span class="badge bg-warning text-dark ms-2">${characterGuess}</span>
                                    </h5>
                                </div>
                    ...
                    <div class="col-md-6">
                        <div class="card shadow-sm border-0 h-100">
                            <div class="card-header bg-success text-white">
                                <h5 class="card-title mb-0"><i class="bi bi-star-fill"></i>Your Performance</h5>
                            </div>
            ...
            <div class="text-center mt-4">
                <form method="get" action="GameServlet" class="d-inline me-3">
                    <button type="submit" class="btn btn-primary btn-lg"><i class="bi bi-play-fill"></i>Play Again</button>
                </form>

                <form method="get" action="../shared/LogoutServlet" class="d-inline">
                    <button type="submit" class="btn btn-outline-danger btn-lg"><i class="bi bi-box-arrow-right"></i>Logout</button>
                </form>
            </div>

            <!-- High Scores Table -->
            <jsp:include page="leaderboardSW.jsp" />
        </div>
    </div>
