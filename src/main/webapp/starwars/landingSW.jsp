...
<head>
    ...
    <title>Star Wars Borders Game</title>
    ...
    <div class="container mt-5">
        <div class="row justify-content-center">
            <div class="col-md-8 text-center">
                <h1 class="display-4">Welcome to Star Wars's Game!</h1>
                <p class="lead">Test your skills by guessing the species of each Star Wars character!</p>
                <a href="${pageContext.request.contextPath}/starwars/GameServlet" class="btn btn-success btn-lg m-4">Start Playing</a>
                ...
                <div class="card shadow">
                    <div class="card-body">
                        ...
                        <ul class="list-group list-group-flush text-start">
                            ...
                            <li class="list-group-item">Guess the species of characters.</li>
