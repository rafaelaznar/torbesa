                    ...
                    <div class="container">
                        ...
                        <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 g-4">
                            ...
                            <div class="col">
                                <div class="card game-card shadow-sm border-0 h-100">
                                    <div class="card-body text-center p-4">
                                        ...
                                        <p class="card-text text-muted mb-4">Test your geography knowledge and guess the
                                            capital city for each country.</p>
                            ...
                            <div class="col">
                                <div class="card game-card shadow-sm border-0 h-100">
                                    <div class="card-body text-center p-4">
                                        ...
                                        <p class="card-text text-muted mb-4">Test your geography knowledge! Guess the
                                            capital cities of countries from around the world.</p>
                            ...
                            <div class="col">
                                <div class="card game-card shadow-sm border-0 h-100">
                                    <div class="card-body text-center p-4">
                                        ...
                                        <p class="card-text text-muted mb-4">Guess which team each driver races for
                                            using live F1 data.</p>
                            ...
                            <div class="col">
                                <div class="card game-card shadow-sm border-0 h-100">
                                    <div class="card-body text-center p-4">
                                        ...
                                        <p class="card-text text-muted mb-4">Test your Star Wars knowledge! Guess the
                                            species of each Star Wars character.</p>
                                        <p class="card-text text-muted mb-4">By Daniel Zanón Rodas</p>
                                        <a href="../starwars/landingSW.jsp" class="btn btn-primary btn-lg w-100"><i
                                                class="bi bi-play-fill"></i> Play Now</a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col">
                                <div class="card game-card shadow-sm border-0 h-100">
                                    <div class="card-body text-center p-4">
                                        <div class="mb-3"><i class="bi bi-calculator text-warning"
                                                style="font-size: 3rem;"></i></div>
                                        <h5 class="card-title text-warning mb-3">Math Challenge</h5>
                                        <p class="card-text text-muted mb-4">Solve timed arithmetic problems and climb
                                            the leaderboard.</p>
                                        <p class="card-text text-muted mb-4 small">By Hector Jose Fernandez</p>
                                        <a href="../math/landing.jsp" class="btn btn-warning btn-lg w-100 text-dark"><i
                                                class="bi bi-play-fill"></i> Play Now</a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col">
                                <div class="card game-card shadow-sm border-0 h-100">
                                    <div class="card-body text-center p-4">
                                        <div class="mb-3"><i class="bi bi-question-circle text-warning"
                                                style="font-size: 3rem;"></i></div>
                                        <h5 class="card-title text-warning mb-3">Trivial</h5>
                                        <p class="card-text text-muted mb-4">Answer general knowledge questions and keep
                                            your streak alive.</p>
                                        <p class="card-text text-muted mb-4 small">By Marcos Pallás</p>
                                        <a href="../trivial/landing_j.jsp" class="btn btn-primary btn-lg w-100"><i
                                                class="bi bi-play-fill"></i> Play Now</a>
                                    </div>
                                </div>
                            </div>

                            <!-- Computer Science Trivia (Reyna) -->
                            <div class="col">
                                <div class="card game-card shadow-sm border-0 h-100">
                                    <div class="card-body text-center p-4">
                                        <div class="mb-3"><i class="bi bi-cpu text-danger" style="font-size: 3rem;"></i>
                                        </div>
                                        <h5 class="card-title text-danger mb-3">Computer Science Trivia</h5>
                                        <p class="card-text text-muted mb-4">Take on tech-flavored questions and prove
                                            your CS knowledge.</p>
                                        <p class="card-text text-muted mb-4 small">By Ronald Reyna</p>
                                        <a href="../trivialReyna/landing.jsp" class="btn btn-danger btn-lg w-100"><i
                                                class="bi bi-play-fill"></i> Play Now</a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col">
                                <div class="card game-card shadow-sm border-0 h-100">
                                    <div class="card-body text-center p-4">
                                        <div class="mb-3"><i class="bi bi-translate text-success"
                                                style="font-size: 3rem;"></i></div>
                                        <h5 class="card-title text-success mb-3">Language Quiz</h5>
                                        <p class="card-text text-muted mb-4">Match words and expressions across multiple
                                            languages.</p>
                                        <p class="card-text text-muted mb-4 small">By Ariel Sempertegui</p>
                                        <a href="../sempertegui/languageLanding.jsp"
                                            class="btn btn-success btn-lg w-100"><i class="bi bi-play-fill"></i> Play
                                            Now</a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col">
                                <div class="card game-card shadow-sm border-0 h-100">
                                    <div class="card-body text-center p-4">
                                        <div class="mb-3"><i class="bi bi-stack text-warning"
                                                style="font-size: 3rem;"></i></div>
                                        <h5 class="card-title text-warning mb-3">Trivia (API)</h5>
                                        <p class="card-text text-muted mb-4">Pull fresh questions from Open Trivia DB
                                            and see how far you can go.</p>
                                        <p class="card-text text-muted mb-4 small">By Ivan Afonso</p>
                                        <a href="<%= request.getContextPath() %>/trivia"
                                            class="btn btn-outline-warning btn-lg w-100"><i class="bi bi-play-fill"></i>
                                            Play Now</a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col">
                                <div class="card game-card shadow-sm border-0 h-100">
                                    <div class="card-body text-center p-4">
                                        ...
                                        <a href="../whosthatpokemon/landingpokemon.jsp"
                                            class="btn btn-primary btn-lg w-100"><i class="bi bi-play-fill"></i> Play
                                            Now</a>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card game-card shadow-sm border-0 h-100">
                                    <div class="card-body text-center p-4">
                                        ...
                                        <p class="card-text text-muted mb-4">Pick the correct ability for each Pokémon
                                            and chase a perfect score.</p>
                                        <p class="card-text text-muted mb-4 small">By David Gabriel Calinescu</p>
                                        <a href="../pokemon/landing.jsp"
                                            class="btn btn-warning btn-lg w-100 text-dark"><i
                                                class="bi bi-play-fill"></i> Play Now</a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col">
                                <div class="card game-card shadow-sm border-0 h-100">
                                    <div class="card-body text-center p-4">
                                        <div class="mb-3"><i class="bi bi-emoji-smile text-primary"
                                                style="font-size: 3rem;"></i></div>
                                        <h5 class="card-title text-primary mb-3">Emoji Quiz</h5>
                                        <p class="card-text text-muted mb-4">Decode movie titles from emoji combinations
                                            and beat the ranking.</p>
                                        <p class="card-text text-muted mb-4 small">By Vladislav Uski</p>
                                        <a href="../emojiQuiz/landing.jsp" class="btn btn-primary btn-lg w-100"><i
                                                class="bi bi-play-fill"></i> Play Now</a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col">
                                <div class="card game-card shadow-sm border-0 h-100">
                                    <div class="card-body text-center p-4">
                                        <div class="mb-3"><i class="bi bi-fire text-success"
                                                style="font-size: 3rem;"></i></div>
                                        <h5 class="card-title text-success mb-3">Demon Slayer Quiz</h5>
                                        <p class="card-text text-muted mb-4">Demon Slayer fans: answer lore questions
                                            and keep your streak going.</p>
                                        <p class="card-text text-muted mb-4 small">By Olga García</p>
                                        <a href="../kimetsu/landing.jsp" class="btn btn-success btn-lg w-100"><i
                                                class="bi bi-play-fill"></i> Play Now</a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col">
                                <div class="card game-card shadow-sm border-0 h-100">
                                    <div class="card-body text-center p-4">
                                        <div class="mb-3"><i class="bi bi-stars text-info" style="font-size: 3rem;"></i>
                                        </div>
                                        <h5 class="card-title text-info mb-3">Honkai Star Rail</h5>
                                        <p class="card-text text-muted mb-4">Guess each character's element and climb
                                            the leaderboard.</p>
                                        <p class="card-text text-muted mb-4 small">By Álvaro Contreras</p>
                                        <a href="../find_it_alvaro/landing.jsp"
                            ...
                            <div class="col">
                                <div class="card game-card shadow-sm border-0 h-100">
                                    <div class="card-body text-center p-4">
                                        <div class="mb-3"><i class="bi bi-magic text-primary"
                                                style="font-size: 3rem;"></i></div>
                                        <h5 class="card-title text-primary mb-3">Harry Potter Quiz</h5>
                                        <p class="card-text text-muted mb-4">Decide which Hogwarts house each character
                                            belongs to and earn points.</p>
                                        <p class="card-text text-muted mb-4 small">By Ana Silvestre</p>
                                        <a href="../harrypotter/landing.jsp" class="btn btn-primary btn-lg w-100"><i
                                                class="bi bi-play-fill"></i> Play Now</a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col">
                                <div class="card game-card shadow-sm border-0 h-100">
                                    <div class="card-body text-center p-4">
                                        <div class="mb-3"><i class="bi bi-joystick text-secondary"
                                                style="font-size: 3rem;"></i></div>
                                        <h5 class="card-title text-secondary mb-3">More games coming soon</h5>
                                        <p class="card-text text-muted mb-4">Stay tuned for new class projects landing
                                            on torbesa.</p>
                                        <button class="btn btn-outline-secondary btn-lg w-100" disabled><i
                                                class="bi bi-hourglass-split"></i> In progress</button>
                                    </div>
                                </div>
                            </div>
