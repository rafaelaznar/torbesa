...
uri="http://java.sun.com/jsp/jstl/fmt" %> <% if
      ...
      <div class="row justify-content-center">
        <div class="col-lg-10">
          <div class="text-center mb-4">
            <h1 class="display-4 results-title">🎯 Game Results ⚡</h1>
          </div>

          <c:if test="${not empty message}">
            <div
              class="alert alert-info alert-dismissible fade show pokemon-card"
              role="alert"
            >
                ...
                <div class="card-body">
                  <div class="mb-3">
                    <h5>
                      ...
                      <span class="badge pokemon-name ms-2"
                        >${pokemonName}</span
                      >
                    </h5>
                  </div>
                  <div class="mb-3">
                    <h5>
                      ...
                      <span class="badge ability-guess ms-2"
                        >${abilityGuess}</span
                      >
                    </h5>
                  </div>
                  <div class="mb-0">
                    <h5>
                      ...
                      <span class="badge ability-correct ms-2"
                        >${correctAbility}</span
                      >
                    </h5>
                  </div>
                ...
                <div class="card-body">
                  ...
                  <div class="text-center">
                    <small class="text-muted h5">
                      ...
                      <fmt:formatDate
                        value="${userScore.timestampAsDate}"
