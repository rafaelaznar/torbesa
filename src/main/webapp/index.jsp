  ...
  <body>
    <section class="hero-section text-center">
      <div class="container">
        ...
        <p class="fs-5">
          Challenge yourself with fun projects from the whole class
        </p>
      </div>
    </section>
    ...
    <div class="container my-4 d-flex justify-content-center">
      ...
      <a
        href="shared/signup.jsp"
        class="btn btn-warning btn-lg"
        style="min-width: 180px; color: #212529"
      >
        Sign up
      </a>
    </div>
          ...
          <div class="col-md-6 col-lg-4">
            <div class="card game-card shadow-sm border-0 h-100">
              <div class="card-body text-center p-4">
                <div class="mb-3">
                  <i
                    class="bi bi-code-slash text-success"
                    style="font-size: 3rem"
                  ></i>
                </div>
                <h5 class="card-title text-success mb-3">CodeQuest</h5>
                <p class="card-text text-muted mb-4">
                  Test your programming knowledge! Identify technologies,
                  frameworks, and tools from their descriptions.
                </p>
                <p class="card-text text-muted mb-4">By Pollyanna Soares</p>
                <a
                  href="codequest/landing.jsp"
          ...
          <div class="col-md-6 col-lg-4">
            <div class="card game-card shadow-sm border-0 h-100">
              <div class="card-body text-center p-4">
                <div class="mb-3">
                  <i
                    class="bi bi-speedometer2 text-danger"
                    style="font-size: 3rem"
                  ></i>
                </div>
          ...
          <div class="col">
            <div class="card game-card h-100 border-0 shadow-sm">
              <div class="card-body text-center p-4">
                ...
                <p class="card-text text-muted mb-4 small">
                  By Ariel Sempertegui
                </p>
                <a
                  href="sempertegui/languageLanding.jsp"
                  class="btn btn-success btn-lg w-100"
                >
                  <i class="bi bi-play-fill"></i> Play Now
                </a>
          ...
          <div class="col">
            <div class="card game-card h-100 border-0 shadow-sm">
              <div class="card-body text-center p-4">
                <div class="mb-3">
                  <i
                    class="bi bi-stack text-warning"
                    style="font-size: 3rem"
                  ></i>
                </div>
                <h5 class="card-title text-warning mb-3">Trivia (API)</h5>
                <p class="card-text text-muted mb-4">
                  Pull fresh questions from Open Trivia DB and see how far you
                  can go.
                </p>
                <p class="card-text text-muted mb-4 small">By Ivan Afonso</p>
                <a
                  href="<%= request.getContextPath() %>/trivia"
          ...
          <div class="col">
            <div class="card game-card h-100 border-0 shadow-sm">
              <div class="card-body text-center p-4">
                <div class="mb-3">
                  <i
                    class="bi bi-shield-shaded text-primary"
                    style="font-size: 3rem"
                  ></i>
                </div>
                <h5 class="card-title text-primary mb-3">
                ...
                <p class="card-text text-muted mb-4">
                  Identify the Pokémon from its silhouette before the time runs
                  out.
                </p>
                <p class="card-text text-muted mb-4 small">By Alan Alcañiz</p>
                <a
                  href="whosthatpokemon/landingpokemon.jsp"
                  class="btn btn-primary btn-lg w-100"
                >
                  <i class="bi bi-play-fill"></i> Play Now
                </a>
          ...
          <div class="col">
            <div class="card game-card h-100 border-0 shadow-sm">
              <div class="card-body text-center p-4">
                ...
                <p class="card-text text-muted mb-4">
                  Pick the correct ability for each Pokémon and chase a perfect
                  score.
                </p>
                <p class="card-text text-muted mb-4 small">
          ...
          <div class="col">
            <div class="card game-card h-100 border-0 shadow-sm">
              <div class="card-body text-center p-4">
                <div class="mb-3">
                  <i
                    class="bi bi-emoji-smile text-primary"
                    style="font-size: 3rem"
                  ></i>
                </div>
                <h5 class="card-title text-primary mb-3">Emoji Quiz</h5>
                <p class="card-text text-muted mb-4">
                  Decode movie titles from emoji combinations and beat the
                  ranking.
                </p>
                <p class="card-text text-muted mb-4 small">By Vladislav Uski</p>
                <a
                  href="emojiQuiz/landing.jsp"
                  class="btn btn-primary btn-lg w-100"
                >
                  <i class="bi bi-play-fill"></i> Play Now
                </a>
          ...
          <div class="col">
            <div class="card game-card h-100 border-0 shadow-sm">
              <div class="card-body text-center p-4">
                <div class="mb-3">
                  <i
                    class="bi bi-fire text-success"
                    style="font-size: 3rem"
                  ></i>
                </div>
                <h5 class="card-title text-success mb-3">Demon Slayer Quiz</h5>
                <p class="card-text text-muted mb-4">
                  Demon Slayer fans: answer lore questions and keep your streak
                  going.
                </p>
                <a
                  href="kimetsu/landing.jsp"
                  class="btn btn-success btn-lg w-100"
                >
                  <i class="bi bi-play-fill"></i> Play Now
                </a>
          ...
          <div class="col">
            <div class="card game-card h-100 border-0 shadow-sm">
              <div class="card-body text-center p-4">
                ...
                <a
                  href="find_it_alvaro/landing.jsp"
                  class="btn btn-info btn-lg w-100 text-dark"
                >
                  <i class="bi bi-play-fill"></i> Play Now
                </a>
              </div>
          ...
          <div class="col">
            <div class="card game-card h-100 border-0 shadow-sm">
              <div class="card-body text-center p-4">
                ...
                <p class="card-text text-muted mb-4">
                  Decide which Hogwarts house each character belongs to and earn
                  points.
                </p>
                <a
                  href="harrypotter/landing.jsp"
                  class="btn btn-primary btn-lg w-100"
                >
                  <i class="bi bi-play-fill"></i> Play Now
                </a>
          ...
          <div class="col">
            <div class="card game-card h-100 border-0 shadow-sm">
              <div class="card-body text-center p-4">
                <div class="mb-3">
                  <i
                    class="bi bi-arrow-through-heart text-dark"
                    style="font-size: 3rem"
                  ></i>
                </div>
          ...
          <div class="col">
            <div class="card game-card h-100 border-0 shadow-sm">
              <div class="card-body text-center p-4">
                <div class="mb-3">
                  <i
                    class="bi bi-joystick text-secondary"
                    style="font-size: 3rem"
                  ></i>
                </div>
