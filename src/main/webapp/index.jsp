                    ...
                    <div class="col">
                        <div class="card game-card shadow-sm border-0 h-100">
                            <div class="card-body text-center p-4">
                                ...
                                <p class="card-text text-muted mb-4">Test your geography knowledge! Guess the capital
                                    cities of countries from around the world.</p>
            ...
            <div class="col">
                <div class="card game-card shadow-sm border-0 h-100">
                    ...
                    <div class="col">
                        <div class="card game-card shadow-sm border-0 h-100">
                            <div class="card-body text-center p-4">
                                ...
                                <p class="card-text text-muted mb-4">Test your Star Wars knowledge! Guess the species of
                                    each Star Wars character.</p>
                    ...
                    <div class="col">
                        <div class="card game-card shadow-sm border-0 h-100">
                            <div class="card-body text-center p-4">
                                <div class="mb-3"><i class="bi bi-calculator text-warning" style="font-size: 3rem;"></i>
                                </div>
                                <h5 class="card-title text-warning mb-3">Math Challenge</h5>
                                <p class="card-text text-muted mb-4">Solve timed arithmetic problems and climb the
                                    leaderboard.</p>
                    ...
                    <div class="col">
                        <div class="card game-card shadow-sm border-0 h-100">
                            <div class="card-body text-center p-4">
                                ...
                                <p class="card-text text-muted mb-4">Answer general knowledge questions and keep your
                                    streak alive.</p>
                    ...
                    <div class="col">
                        <div class="card game-card shadow-sm border-0 h-100">
                            <div class="card-body text-center p-4">
                                ...
                                <p class="card-text text-muted mb-4">Take on tech-flavored questions and prove your CS
                                    knowledge.</p>
                    ...
                    <div class="col">
                        <div class="card game-card shadow-sm border-0 h-100">
                            <div class="card-body text-center p-4">
                                <div class="mb-3"><i class="bi bi-translate text-success" style="font-size: 3rem;"></i>
                                </div>
                                ...
                                <a href="sempertegui/languageLanding.jsp" class="btn btn-success btn-lg w-100"><i
                                        class="bi bi-play-fill"></i> Play Now</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col">
                        <div class="card game-card shadow-sm border-0 h-100">
                            <div class="card-body text-center p-4">
                                <div class="mb-3"><i class="bi bi-stack text-warning" style="font-size: 3rem;"></i>
                                </div>
                                <h5 class="card-title text-warning mb-3">Trivia (API)</h5>
                                <p class="card-text text-muted mb-4">Pull fresh questions from Open Trivia DB and see
                                    how far you can go.</p>
                                <p class="card-text text-muted mb-4 small">By Ivan Afonso</p>
                                <a href="<%= request.getContextPath() %>/trivia"
                                    class="btn btn-outline-warning btn-lg w-100"><i class="bi bi-play-fill"></i> Play
                                    Now</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col">
                        <div class="card game-card shadow-sm border-0 h-100">
                            <div class="card-body text-center p-4">
                                ...
                                <p class="card-text text-muted mb-4">Identify the Pokémon from its silhouette before the
                                    time runs out.</p>
                    ...
                    <div class="col">
                        <div class="card game-card shadow-sm border-0 h-100">
                            <div class="card-body text-center p-4">
                                ...
                                <p class="card-text text-muted mb-4">Pick the correct ability for each Pokémon and chase
                                    a perfect score.</p>
                    ...
                    <div class="col">
                        <div class="card game-card shadow-sm border-0 h-100">
                            <div class="card-body text-center p-4">
                                ...
                                <p class="card-text text-muted mb-4">Decode movie titles from emoji combinations and
                                    beat the ranking.</p>
                    ...
                    <div class="col">
                        <div class="card game-card shadow-sm border-0 h-100">
                            <div class="card-body text-center p-4">
                                ...
                                <p class="card-text text-muted mb-4">Demon Slayer fans: answer lore questions and keep
                                    your streak going.</p>
                    ...
                    <div class="col">
                        <div class="card game-card shadow-sm border-0 h-100">
                            <div class="card-body text-center p-4">
                                ...
                                <p class="card-text text-muted mb-4">Guess each character's element and climb the
                                    leaderboard.</p>
                                <p class="card-text text-muted mb-4 small">By Álvaro Contreras</p>
                                <a href="find_it_alvaro/landing.jsp" class="btn btn-info btn-lg w-100 text-dark"><i
                                        class="bi bi-play-fill"></i> Play Now</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col">
                        <div class="card game-card shadow-sm border-0 h-100">
                            <div class="card-body text-center p-4">
                                ...
                                <a href="genshinPav/landing.jsp" class="btn btn-info btn-lg w-100 text-dark"><i
                                        class="bi bi-play-fill"></i> Play Now</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col">
                        <div class="card game-card shadow-sm border-0 h-100">
                            <div class="card-body text-center p-4">
                                <div class="mb-3"><i class="bi bi-magic text-primary" style="font-size: 3rem;"></i>
                                </div>
                                <h5 class="card-title text-primary mb-3">Harry Potter Quiz</h5>
                                <p class="card-text text-muted mb-4">Decide which Hogwarts house each character belongs
                                    to and earn points.</p>
                    ...
                    <div class="col">
                        <div class="card game-card shadow-sm border-0 h-100">
                            <div class="card-body text-center p-4">
                                ...
                                <p class="card-text text-muted mb-4">Match the song to its album in this music-themed
                                    challenge.</p>
                    ...
                    <div class="col">
                        <div class="card game-card shadow-sm border-0 h-100">
                            <div class="card-body text-center p-4">
                                <div class="mb-3"><i class="bi bi-joystick text-secondary" style="font-size: 3rem;"></i>
                                </div>
                                <h5 class="card-title text-secondary mb-3">More games coming soon</h5>
                                <p class="card-text text-muted mb-4">Stay tuned for new class projects landing on
                                    torbesa.</p>
