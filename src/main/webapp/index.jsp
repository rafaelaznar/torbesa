                            ...
                            <div class="col-md-6 col-lg-4">
                                <div class="card game-card shadow-sm border-0 h-100">
                                    <div class="card-body text-center p-4">
                                        ...
                                        <p class="card-text text-muted mb-4">
                                            Test your programming knowledge! Identify technologies, frameworks, and tools from their descriptions.
                                        </p>
                                        <p class="card-text text-muted mb-4">
                                            By Pollyanna Soares
                                        </p>
                                        <a href="codequest/landing.jsp" class="btn btn-success btn-lg w-100">
                                            <i class="bi bi-play-fill"></i> Play Now
                                        </a>
                                    </div>
                                </div>
