  ...
  <body>
    ...
    <div class="container my-4 d-flex justify-content-center">
      <a
        ...
        style="min-width: 180px; font-size: 1.3rem"
        >Login to play</a
      >
      <a
        href="shared/signup.jsp"
        class="btn btn-warning btn-lg"
        style="min-width: 180px; font-size: 1.3rem; color: #212529"
        >Sign up</a
      >
    </div>
    <!-- Login/Signup Buttons -->
              ...
              <div class="col-md-6 col-lg-4">
                <div class="card game-card shadow-sm border-0 h-100">
                  <div class="card-body text-center p-4">
                    ...
                    <p class="card-text text-muted mb-4">
                      Test your knowledge of films and match emojis with the
                      correct answer!
                    </p>
                    <p class="card-text text-muted mb-4">By Vladislav Uski</p>
                    <a
