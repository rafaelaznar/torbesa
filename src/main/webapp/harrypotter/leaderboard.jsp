...
<div class="card shadow-sm border-0 mt-4">
    <div class="card-header bg-primary text-white">
        <h5 class="card-title mb-0">
            <i class="bi bi-magic"></i> Harry Potter Quiz Leaderboard 🏆
        </h5>
    </div>
            ...
            <table class="table table-hover table-striped mb-0">
                <thead class="table-dark">
                    <tr>
                        ...
                        <th scope="col"><i class="bi bi-person-fill"></i> Wizard</th>
                        ...
                        <c:when test="${empty highScores}">
                            <tr>
                                <td colspan="6" class="text-center py-4">
                                    ...
                                    <p class="mb-0">No magical scores yet! Be the first wizard to play! 🪄</p>
                                </td>
                            </tr>
                        </c:when>
                        <c:otherwise>
    ...
    <div class="card-footer bg-light text-center">
        <small class="text-muted">
            <i class="bi bi-magic"></i> May the magic be with you! Cast your spells wisely! ⚡
        </small>
    </div>
</div>
