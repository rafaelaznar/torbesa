        ...
        <div class="container mt-5">
            <div class="row justify-content-center">
                <div class="col-md-8 text-center">
                    ...
                    <p class="lead">Test your brain skills by guessing the correct answer!</p>
                    <a href="../trivial/TrivialServlet" class="btn btn-success btn-lg m-4">Start Playing</a>
                    <a href="../trivial/ScoreServlet" class="btn btn-warning btn-lg m-4">Top scores</a>
                </div>
            </div>
            <div class="row mt-5">
                    ...
                    <div class="card shadow">
                        <div class="card-body">
                            ...
                            <ul class="list-group list-group-flush text-start">
                                ...
                                <li class="list-group-item">Guess the answer.</li>
