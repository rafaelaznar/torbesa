        ...
        <div class="container mt-5">
            <div class="row justify-content-center">
                <div class="col-md-8 text-center">
                    <h1 class="display-4">Welcome to the Dog's Game!</h1>
                    <p class="lead">Test how much you know about dog breeds!</p>
                    <a href="../perro/JuegoServlet" class="btn btn-success btn-lg m-4">Start Playing</a>
                    <a href="../perro/PuntuacionServlet" class="btn btn-warning btn-lg m-4">Top scores</a>
                </div>
            </div>
            <div class="row mt-5">
