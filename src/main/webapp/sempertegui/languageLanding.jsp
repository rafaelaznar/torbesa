        ...
        <div class="container mt-5">
            <div class="row justify-content-center">
                <div class="col-md-8 text-center">
                    ...
                    <a href="../sempertegui/languageGameServlet" class="btn btn-success btn-lg m-4">Start Playing</a>
                    <a href="../sempertegui/languageScoreServlet" class="btn btn-warning btn-lg m-4">Top scores</a>
                </div>
            </div>
            <div class="row mt-5">
